...
def clear_data():
    ...
    if (os.path.isfile(variables_path) and os.path.isfile(punches_path) and os.path.isfile(walking_path) and os.path.isfile(description_path) and os.path.isfile(must_clear_path)):
        ...
        if (can_clear):
            ...
            # Punches Fields
            thursday_punches = ["None"]
            app.weekly_daily_tabs.weekly_tab.programming_frame.saturday_punches_entry.configure(values=thursday_punches)

            friday_punches = ["None"]
            app.weekly_daily_tabs.weekly_tab.programming_frame.saturday_punches_entry.configure(values=friday_punches)

            saturday_punches = ["None"]
            app.weekly_daily_tabs.weekly_tab.programming_frame.saturday_punches_entry.configure(values=saturday_punches)

            sunday_punches = ["None"]
            app.weekly_daily_tabs.weekly_tab.programming_frame.saturday_punches_entry.configure(values=sunday_punches)

            monday_punches = ["None"]
            app.weekly_daily_tabs.weekly_tab.programming_frame.saturday_punches_entry.configure(values=monday_punches)

            tuesday_punches = ["None"]
            app.weekly_daily_tabs.weekly_tab.programming_frame.saturday_punches_entry.configure(values=tuesday_punches)

            wednesday_punches = ["None"]
            app.weekly_daily_tabs.weekly_tab.programming_frame.saturday_punches_entry.configure(values=wednesday_punches)
...
class TotalsFrame(CTk.CTkFrame):
    def __init__(self, master):
        ...
        self.time_programming_entry.grid(row=2, column=1, padx=(108, 50), pady=(5,5))
